...
// console.log(calculator('nine', 7, multiply))
...
console.log(makeWhiteSandwich(['cheese']))
...
//Write a function that will, using the above functions, convert the lotr array above into the different casings in a new variable
// CODE HERE


//EXTRA CHALLENGE
//Rewrite the for loops in the above functions to use higher order array methods
//CODE HERE
